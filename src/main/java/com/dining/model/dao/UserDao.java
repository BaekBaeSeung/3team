...
public class UserDao extends SuperDao{
	...
	/*Customer
U_id(PK)	VARCHAR(30)	유저 아이디(PK)	NOT NULL	미로그인(0),일반 사용자(1), 관리자(2)
Password	VARCHAR(30)	유저 비밀번호	NOT NULL	N/A
Name	VARCHAR(30)	유저 이름	NOT NULL	N/A
Nickname	VARCHAR(30)	유저 닉네임	NOT NULL	N/A
Phone	VARCHAR(30)	전화번호	NOT NULL	N/A
Birth	DATE	유저 생년월일	NOT NULL	N/A
Email	VARCHAR(30)	유저 이메일	NOT NULL	N/A
Address	VARCHAR(255)	유저 주소	NOT NULL	N/A
Address_Detail	VARCHAR(128)	유저 상세주소	NULL	N/A
*/
	...
	public User getDataByIdAndPassword(String U_id, String password) {
	...
	/*public List<User> getDataList02(){
		...
		dataList.add(new User("kimho", "김호철", "abc123", "female", "2023/08/20", "미혼", "music/art/sport/reading/", "마포", 100));
		dataList.add(new User("park", "박혁신", "abc123", "male", "2002/06/24", "미혼", "music/art/photo/cooking/", "용산", 200));		
		dataList.add(new User("choi", "최만위", "abc123", "female", "2020/12/12", "이혼", "travel/photo/cooking/", "강남", 300));		
		dataList.add(new User("kim", "김동섭", "abc123", "male", "2023/08/20", "결혼", "music/art/photo/cooking/", "마포", 400));
		dataList.add(new User("lee", "이수돌", "abc123", "male", "2023/08/20", "이혼", "music/art/sport/reading/", "서대문", 500));
	...
	*/
	...
	private User resultSet2Bean(ResultSet rs) {
		try {
			User bean = new User() ;
			bean.setU_id(rs.getString("gender"));
