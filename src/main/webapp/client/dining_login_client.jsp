...
<body>
	...
	<input type="hidden" name="command" value="ClientLogin">
		<div class="login-container">
			<label for="C_id">Client ID :</label> <input type="text" id="C_id"
				name="C_id" placeholder="업체 아이디를 입력하세요"> <label
			...
			<p>
				회원이 아니신가요? &nbsp;&nbsp;&nbsp; <a href="./CustomerInsertForm.jsp"
					class="join">업체 회원가입</a>
			</p>
		</div>
