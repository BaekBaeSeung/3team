...
<body>
			...
			<div class="column2- column2-1"
				...
				<div class="image-slider-container"
					...
					<div class="image-slider" style="width: 100%; height: 100%;">
						...
						<img src="/Dining01/image/스케쥴청담01.jpg" alt="Image 1"
				...
				<div style="margin: 100px 30px 30px 30px;">
					...
					<div class="detailform">
						<label for="address">주소:</label> <input type="text" id="address"
							name="address" value="서울 강남구 선릉로152길 37 1층" readonly
							style="width: 300px;"><br>
					</div>
					<div class="detailform">
						<label for="businessHours">영업시간:</label> <input type="text"
					...
					<div class="container mt-3">
						<button type="button" class="btn btn-light"
							...
							확인해 보세요.</button>
						<div id="demo" class="collapse">매장이 바쁜 경우 전화응대가 어려울 수 있다는 점 양해 부탁드리겠습니다.
						스케줄은 다양한 음식, 디저트와 함께 주류 및 최상의 서비스까지 한 자리에서 즐길 수 있는 트렌디한 복합 문화 공간입니다.</div>
					</div>
	...
	<script>
		var currentSlide = 0;
		var slides = [ '/Dining01/image/스케쥴청담02.jpg',
				'/Dining01/image/스케쥴청담03.jpg', '/Dining01/image/스케쥴청담07.jpg',
				'/Dining01/image/스케쥴청담04.jpg' ]; // 이미지 파일 경로들
