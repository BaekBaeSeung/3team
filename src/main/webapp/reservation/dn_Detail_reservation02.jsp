		...
		<div class="column2">
			...
			<div class="column2- column2-2"
				...
				<div style="margin: 100px 30px 30px 30px;">
					<div>
						<strong><span
							style="font-size: 35px; white-space: nowrap;" class="text">삿뽀로</span></strong>
					...
					<div class="detailform">
						<label for="address">주소:</label> <input type="text" id="address"
							name="address" value="서울 은평구 서오릉로 5길 19-8" readonly
							style="width: 300px;"><br>
					</div>
					<div class="detailform">
						<label for="businessHours">영업시간:</label> <input type="text"
							id="businessHours" name="businessHours" value="매일 09:00~18:00시까지"
					...
					<div class="detailform">
						<label for="phoneNumber">전화번호:</label> <input type="text"
							id="phoneNumber" name="phoneNumber" value="02-448-5568" readonly
							style="width: 300px;"><br>
					</div>
