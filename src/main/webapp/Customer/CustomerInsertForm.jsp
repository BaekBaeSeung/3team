        ...
        <form class="validation-form" novalidate action="<%=withFormTag%>" method="post" name="myform">
          ...
          <div class="row">
			...
			<label for="name">아이디</label>
              <input type="text" class="form-control" id="U_id" name="U_id" placeholder="아이디" value="" required>
              ...
              <input type="text" class="form-control" id="Phone" name="Phone" placeholder="전화번호" value="" required>
              <div class="invalid-feedback">
                전화번호를 입력해주세요.
              </div><br/>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="Address" name="Address" placeholder="●●시 ●●구 ●●동 " required>
            <div class="invalid-feedback">
              주소를 입력해주세요.
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="Address_Detail" name="Address_Detail" placeholder="상세주소를 입력해주세요.">
          </div>

          <div class="row">
            <div class="col-md-8 mb-3">
              <label for="root">선호하는 음식종류(필수아님)</label>
